...
public class ProfileFragment extends Fragment {
    ...
    private void setupToolbar() {
        if (toolbar != null && getActivity() instanceof AppCompatActivity) {
            ...
            if (activity.getSupportActionBar() != null) {
                ...
                activity.getSupportActionBar().setTitle("Мой профиль");
            }
    ...
    private void copyProfileLink() {
        copyToClipboard("Ссылка на профиль", "https://vk.com/id" + userId);
    ...
    public static class ProfilePagerAdapter extends FragmentStateAdapter {
        ...
        public ProfilePagerAdapter(ProfileFragment fragment) {
            super(fragment);
        ...
        public Fragment createFragment(int position) {
            switch (position) {
                ...
                case 1:
                    return MyFriendsFragment.newInstance(fragment.userId, fragment.userName);
                case 2:
