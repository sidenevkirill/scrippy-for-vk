...
public class AuthLocalActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bottomBar.setOnClickListener(v -> {
            Intent intent = new Intent(AuthLocalActivity.this, AuthRefreshToken.class);
    ...
    private void setupTestButtons() {
        ...
        @SuppressLint("WrongViewCast") LinearLayout mainLayout = findViewById(R.id.main_layout); // Замените на ID вашего основного layout
        if (mainLayout != null) {
        ...
        new Thread(() -> {
            try {
                String url = "https://api.vk.com/method/users.get?user_ids=" + userId +
                        "&fields=photo_200&access_token=" + accessToken + "&v=5.131";
