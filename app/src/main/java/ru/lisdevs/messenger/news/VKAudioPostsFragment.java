...
import ru.lisdevs.messenger.account.AcountPostsFragment;
import ru.lisdevs.messenger.utils.TokenManager;

public class VKAudioPostsFragment extends Fragment {
        ...
        protected List<PostItem> doInBackground(Void... voids) {
            ...
            try {
                URL url = new URL("https://api.vk.com/method/wall.get" +
                        "?owner_id=" + URLEncoder.encode(String.valueOf(-231807504), "UTF-8") +
                        "&count=20" +
